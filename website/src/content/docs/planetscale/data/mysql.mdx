...
[`Drizzle.MySQL`](/sql/drizzle/mysql) or the raw
[`SQL.MySQL`](/sql/effect-sql/mysql) client — both take Hyperdrive's
...
- [Drizzle: MySQL](/sql/drizzle/mysql) /
  [Effect SQL: MySQL](/sql/effect-sql/mysql) — the runtime clients.
